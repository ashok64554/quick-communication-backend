...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::connection('mysql_twoway')->hasTable('two_way_comm_ratings')) 
        {
            Schema::connection('mysql_twoway')->create('two_way_comm_ratings', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::connection('mysql_twoway')->dropIfExists('two_way_comm_ratings');
    }
};
